...
export const normalizeSeasonState = (savedSeasonState, seasonLabel) =>
  savedSeasonState && typeof savedSeasonState === "object"
    ? {
      ...
      aiTradeOffers: Array.isArray(savedSeasonState.aiTradeOffers) ? savedSeasonState.aiTradeOffers : [],
      aiTradeOfferCount: Number(savedSeasonState.aiTradeOfferCount) || 0,
      aiTradeOfferTarget: Number(savedSeasonState.aiTradeOfferTarget) || null,
