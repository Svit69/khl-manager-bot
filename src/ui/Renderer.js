...
export class Renderer{
  ...
  renderFantasyDraft(draft,team){
    ...
    this.#calEl.innerHTML=`<h2>\u041a\u0430\u043b\u0435\u043d\u0434\u0430\u0440\u044c \u2022 ${currentDateLabel}</h2><div class="row"><div>${text}</div><button id="playBtn" class="btn" ${isLocked?"disabled":""}>${playButtonLabel}</button></div>${tabButtons}<div class="calendar-panel-list${panelClass}">${tableHeader}<div class="calendar-panel-scroll${panelClass}">${tableBody}</div></div>`;
  }
