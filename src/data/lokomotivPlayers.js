...
const lokomotivRoster = [
  ...
  ["radulov", "Александр", "Радулов", "ПНП", [], photo("radulov"), "1986-07-05", "Россия", 12, 635, 100, 82, 76, 80, 72, 88, 82, "односторонний", [39, 60]],
  ["rafikov", "Рушан", "Рафиков", "ЗАЩ", [], photo("rafikov"), "1995-05-15", "Россия", 11, 589, 100, 73, 78, 78, 79, 78, 80, "односторонний", [56, 56]],
  ["andrei-sergeyev", "Андрей", "Сергеев", "ЗАЩ", [], photo("andrei-sergeyev"), "1991-03-26", "Россия", 17, 785, 100, 71, 77, 81, 81, 74, 80, "односторонний", [60, 57, 60]],
  ["surin", "Егор", "Сурин", "ЛНП", ["ПНП"], photo("surin"), "2006-08-01", "Россия", 3, 101, 100, 70, 74, 82, 75, 78, 85, "двухсторонний", [40, 60]],
  ["ulyev", "Марк", "Ульев", "ЗАЩ", [], photo("ulyev"), "2005-02-06", "Россия", 3, 80, 100, 70, 72, 72, 72, 68, 78, "трехсторонний", [1, 1]],
  ["froese", "Байрон", "Фрэз", "ЦТР", [], photo("froese"), "1991-03-12", "Канада", 2, 127, 100, 75, 76, 72, 78, 79, 77, "односторонний", [26]],
  ["cherepanov", "Никита", "Черепанов", "ЗАЩ", [], photo("cherepanov"), "1995-11-19", "Россия", 11, 575, 100, 70, 75, 77, 78, 73, 77, "односторонний", [32]],
  ["shalunov", "Максим", "Шалунов", "ЦТР", [], photo("shalunov"), "1993-01-31", "Россия", 14, 644, 100, 80, 78, 77, 74, 78, 80, "односторонний", [55, 80, 80]],
  ["pustovoy", "Андрей", "Пустовой", "ПНП", [], photo("pustovoy"), "2008-12-08", "Россия", 0, 0, 100, 67, 72, 74, 66, 77, 83, "трехсторонний", [0.5, 0.5, 1]],
  ["dudorov", "Вадим", "Дудоров", "ПНП", [], photo("dudorov"), "2006-07-21", "Россия", 1, 11, 100, 70, 74, 66, 66, 74, 80, "трехсторонний", [0.5]],
];
