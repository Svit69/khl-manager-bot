...
const sibirRoster = [
  ["mikhail-abramov", "Михаил", "Абрамов", "ЦТР", [], photo("mikhail-abramov"), "2001-03-26", "Россия", 3, 82, 100, 76, 78, 69, 70, 77, 77, "односторонний", [16]],
  ["alanov", "Егор", "Аланов", "ЗАЩ", [], photo("alanov"), "2000-12-16", "Россия", 8, 310, 100, 62, 78, 75, 80, 79, 80, "односторонний", [20, 20]],
  ["andreoff", "Энди", "Андреофф", "ПНП", ["ЦТР"], photo("andreoff"), "1991-05-17", "Канада", 4, 151, 100, 77, 76, 76, 70, 79, 77, "односторонний", [30, 55]],
  ["akhiyarov", "Тимур", "Ахияров", "ЗАЩ", [], photo("akhiyarov"), "1999-09-19", "Россия", 8, 235, 100, 67, 72, 77, 75, 70, 76, "односторонний", [13]],
  ["baklashyov", "Никита", "Баклашев", "ЗАЩ", [], photo("baklashyov"), "2005-02-05", "Россия", 3, 74, 100, 57, 66, 73, 70, 60, 75, "двухсторонний", [0.5, 0.5, 0.5]],
  ["beck", "Тэйлор", "Бек", "ПНП", [], photo("beck"), "1991-05-13", "Канада", 10, 468, 100, 83, 74, 70, 63, 80, 79, "односторонний", [35, 55]],
  ["valitov", "Даниил", "Валитов", "ЗАЩ", [], photo("valitov"), "2000-06-09", "Россия", 7, 64, 100, 60, 72, 74, 70, 67, 74, "двухсторонний", [1, 1]],
  ["gordeyev", "Фёдор", "Гордеев", "ЗАЩ", [], photo("gordeyev"), "1999-01-27", "Россия", 4, 122, 100, 61, 70, 80, 71, 74, 77, "односторонний", [20]],
  ...
  ["priskie", "Чейз", "Приски", "ЗАЩ", [], photo("priskie"), "1996-03-19", "США", 1, 50, 100, 72, 81, 71, 73, 79, 79, "односторонний", [47]],
  ...
  ["shirokov", "Сергей", "Широков", "ЛНП", ["ПНП"], photo("shirokov"), "1986-03-10", "Россия", 16, 803, 100, 77, 72, 74, 72, 78, 76, "односторонний", [30]],
  ...
  ["pershakov", "Александр", "Першаков", "ПНП", [], photo("pershakov"), "2006-10-19", "Россия", 3, 47, 100, 71, 77, 65, 67, 72, 78, "трехсторонний", [0.5, 0.5, 0.5]],
];
