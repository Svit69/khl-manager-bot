export class PlayerSeasonStats{
  #seasonId;#playerId;#games;#goals;#assists;#points;#shots;#totalIceTime;#penaltyMinutes;#plusMinus;
  constructor({seasonId,playerId,games=0,goals=0,assists=0,points=0,shots=0,totalIceTime=0,penaltyMinutes=0,plusMinus=0}){
    this.#seasonId=seasonId;this.#playerId=playerId;this.#games=games;this.#goals=goals;this.#assists=assists;this.#points=points;this.#shots=shots;this.#totalIceTime=totalIceTime;this.#penaltyMinutes=penaltyMinutes;this.#plusMinus=plusMinus;
  }
  ...
  applyMatch({games=1,goals=0,assists=0,shots=0,totalIceTime=0,penaltyMinutes=0,plusMinus=0}={}){
  ...
  importSnapshot({seasonId,games=0,goals=0,assists=0,shots=0,totalIceTime=0,penaltyMinutes=0,plusMinus=0}={}){
